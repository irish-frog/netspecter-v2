...
DEFAULT_CONFIG = {
    ...
    "suricata_log_retention_hours": 1,
    "suricata_active_log_max_mb": 16,
    ...
    "incident_build_batch_size": 100,
    "incident_correlation_log_threshold_seconds": 0.5,
...
INTEGRATION_SETTINGS_KEYS = {
    ...
    "ids_file_retention_days", "ids_raw_flow_retention_hours", "suricata_log_retention_hours",
    "suricata_active_log_max_mb", "ids_structured_max_records",
    ...
    "classification_conntrack_per_device_limit", "destination_visibility_probe_enabled",
    "destination_visibility_nft_target_limit", "destination_visibility_per_device_limit",
    "destination_visibility_device_limit", "destination_visibility_min_total_mb",
    "destination_visibility_max_visible_pct", "destination_visibility_min_write_mb",
    "destination_visibility_recent_lookback_minutes", "destination_sampler_enabled",
    "destination_sampler_interval_seconds", "destination_sampler_duration_seconds",
    "destination_sampler_device_limit", "destination_sampler_target_limit",
    "destination_sampler_per_device_limit", "destination_sampler_min_observed_bytes",
    "destination_sampler_target_ttl_seconds", "flow_visibility_enabled",
    "netflow_receiver_host", "netflow_receiver_port", "netflow_raw_retention_days",
    "netflow_promote_threshold_mb", "netflow_promote_target_limit",
    "netflow_promote_per_device_limit", "softflowd_active_timeout_seconds",
    "softflowd_inactive_timeout_seconds", "destination_identity_enrichment_enabled",
    "destination_identity_enrichment_interval_seconds",
    "destination_identity_enrichment_batch_size", "destination_identity_enrichment_min_mb",
    "expected_download_mbps", "expected_upload_mbps",
